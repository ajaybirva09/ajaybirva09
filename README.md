...
## 🏆 Achievement
- Presented *“Development of an Autonomous Surface Vehicle for Real-Time Aquatic Environment Monitoring and Depth Mapping”* at **CSEAi 2024 (SCOPUS-indexed)**.  
- Secured **₹4,500 funding from KSCST** under Electronics and Communication Engineering.

---

## 🚀 Featured Projects

### **1️⃣ Autonomous Surface Vehicle (ASV)**
...
### **2️⃣ Single-Port Synchronous RAM Design and Verification**
...
### **3️⃣ Automated Sorting Machines**
...
## 📚 Relevant Courses
- SystemVerilog Essentials – Udemy *(May 2025)*  
- Verilog Language and Application – **Cadence**  
- Design for Test Fundamentals – **Cadence**  
- RISC-V Processor - RV321 Base ISA – **Maven Silicon**  
- Python Programming
